...
- Add the remaining Speaking Pattern Core families from the original design spec (~5-10 Speaking Intent categories beyond the 23 shipped so far, e.g. planning/intent variants not yet covered, further work-English scenarios) — seed-content-only, no code changes needed
